...
class StudentController extends Controller
{
                ...
                ->addColumn('action', function ($row) use ($user) {
                    ...
                    $btn .= '<li><a href="' . route('student.edit', $row->id) . '"  title="Edit Student"><i class="fas fa-edit"></i></a></li>
                       ...
                       <li><a href="javascript:void(0)" class="toggle-certificate" data-id="' . $row->id . '" title="Certificate Status"><i class="fas fa-certificate"></i></a></li>
                        <li><a href="javascript:void(0)" class="toggle-active" data-id="' . $row->id . '" title="Active Status"><i class="fas fa-star"></i></a></li>';
                    $btn .= '</ul>';
                    return $btn;
                })
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('profile_image')) {
            ...
            $profileNewName = "profile_image_" . time() . "_" . $profile_image->getClientOriginalName();
            $profile_image->move(public_path('uploads'), $profileNewName);
            $validated['profile_image'] = "uploads/" . $profileNewName;
        } else {
        ...
        // Redirect to student index with success message
